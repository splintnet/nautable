        ...
        <div className="container max-w-screen-xl mx-auto px-4 2xl:px-0 relative">
          <div className="flex flex-col max-w-4xl mx-auto space-y-8">
            <div className="flex flex-col pr-16 md:pr-0 text-white">
              <h1
                className="inline-block mb-2 text-2xl font-semibold tracking-tight lg:text-5xl"
              >
                Boat holidays made
                easy
              </h1>
            ...
            >
              <InputWrapper icon={(
                ...
                >
                  <path
                    d="M9.08 12.432a3.323 3.323 0 100-6.645 3.323 3.323 0 000 6.645z"
                    stroke="currentColor"
                    strokeMiterlimit="10"
                  />
                  <path
              ...
              <button
                type="submit"
                className="border border-transparent rounded text-center appearance-none select-none bg-orange-500 text-white hover:text-white hover:bg-orange-400 active:bg-orange-400 text-base px-6 w-full lg:w-48 h-11"
              >
                Search
              </button>
            </form>
