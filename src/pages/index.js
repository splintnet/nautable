...
export default function Zizoo({reviews}) {
  ...
  return (
    <div>
      ...
      <div className={"py-8 text-white bg-gray-200 relative bg-cover bg-no-repeat bg-center " + styles.hero}>
        <div
          className="absolute inset-x-0 bottom-0 w-full h-full overlay"></div>
        <div className="container max-w-screen-xl mx-auto px-4 2xl:px-0 relative">
            ...
            <form onSubmit={handleSubmit(onSubmit)}
              ...
              <div className="relative w-full bg-white rounded lg:flex-1">
                <svg viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                     className="absolute right-0 w-5 h-6 -mt-px pointer-events-none text-blue-500 top-3 left-2">
                ...
                <div data-testid="location-selector" className="relative">
                  <div className="pl-10 rounded shadow-sm css-b62m3t-container">


                    <input defaultValue="Deutschland" {...register("sd")} />
                  </div>
                </div>
              </div>
              <div className="relative w-full lg:w-56 h-11">
                <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"
                     className="absolute w-5 h-5 pointer-events-none z-5 left-3 top-3 text-blue-500">
                  <path
                ...
                <input type="text"
                       className="w-full text-base truncate bg-white rounded shadow-sm cursor-pointer select-none pl-11 h-full border-none text-blue-500"
                       readOnly=""/>
          ...
          <a href="#trustpilot" tabIndex="-1" className="absolute top-0 right-0 mr-4 -mt-8 overflow-hidden">
            <span
