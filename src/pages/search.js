      ...
      >
         ...
         lg:flex text-gray-700 hidden px-4 lg:block"
          >
            <div className="flex flex-col items-center text-gray-700">
              ...
              <h2 className="mt-3 text-lg font-bold text-gray-700">Got Questions?</h2>
              <p className="mt-2">
                We are here to
                help
                you plan the perfect holiday
              </p>
              <address className="flex flex-col items-center w-full pt-4 space-y-5 not-italic">
                ...
                >
                  ...
                  <a
                    ...
                    className="text-zz-blue-500 hover:text-zz-turquoise-500"
                  >
                    +44 20 3318 3641
                  </a>
                </span>
                <a
                  ...
                  href="https://help.zizoo.com/s/contactsupport?language=en_US"
                >
                  Contact Us
                </a>
              </address>
        ...
        <main className="flex flex-col flex-1 pb-10 space-y-4 lg:p-0">
          <div className="mb-2 flex justify-end">
            ...
            >
              <label
                htmlFor="search-order_by"
                className="hidden mr-2 text-sm font-semibold text-zz-blue-500 lg:inline-block"
              >
                Sort
                by
              </label>
          ...
          <ul className="flex flex-col space-y-3 lg:space-y-4">
            ...
            <li id="disruptor">
              <div>
                ...
                >
                  <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">Get £50 off your next booking</h2>
                  <p
                    className="max-w-3xl mt-3 text-lg text-gray-500"
                  >
                    Subscribe to our newsletter to get a £50 voucher,
                    plus
                    all our top offers and exclusive deals.
                  </p>
                  <div className="mt-8 sm:w-full sm:max-w-md">
                    ...
                    <div className="mt-3 text-sm text-gray-500 has-link-tw">
