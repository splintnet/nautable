          ...
          <div className="grid grid-flow-row grid-cols-1 gap-8 pb-8 md:gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="flex-1"><h4 className="inline-block mb-2 text-sm font-semibold text-blue-500">Zizoo</h4>
              <ul className="flex flex-col space-y-2 text-sm text-blue-500">
                <li><a href="/en/about-zizoo/"
className="flex flex-1 text-sm text-blue-500">About Us</a></li>
                <li><a href="/en/reassurance/"
className="flex flex-1 text-sm text-blue-500">Why Book with Us</a>
                </li>
                <li><a href="/en/press/"
className="flex flex-1 text-sm text-blue-500">Press</a></li>
                <li><a href="https://www.zizoo.com/en/m/"
className="flex flex-1 text-sm text-blue-500">Sailing
                  Magazine</a></li>
                <li><a href="/en/boat-charter/super-deals/"
className="flex flex-1 text-sm text-blue-500">Zizoo
                  Deals</a>
                </li>
...
className="flex flex-1 text-sm text-blue-500">Cookies</a></li>
                <li><a href="/en/data-policy"
className="flex flex-1 text-sm text-blue-500">Data Protection
                  Policy</a>
                </li>
                <li><a href="/en/terms/"
className="flex flex-1 text-sm text-blue-500">Terms of Service</a></li>
              </ul>
            </div>
            <div className="flex-1 lg:-ml-6"><h4
              ...
              <div className="flex flex-col mt-2 space-y-4">
                <ul className="flex flex-col space-y-2 text-sm text-blue-500">
                  ...
                  <li><a href="tel:UK: +33 1 76 44 06 49"
itemProp="telephone"
                         title="Give us a call during opening hours"
                         aria-label="Phone nr.">UK: +33 1 76 44 06 49</a></li>
                  <li>WhatsApp: <a target="_blank"
rel="noreferrer noopener"
                                   href="https://api.whatsapp.com/send?phone=+49 15731910983"
aria-label="whatsapp">+49
                    15731910983</a></li>
                  <li>
            ...
            <div className="flex flex-col space-y-4"><h4
              ...
              <ul className="flex flex-row space-x-4 text-sm text-blue-500">
                <li><a className="flex items-center p-1 border-2 rounded-full border-blue-500"
                       href="https://www.pinterest.com/zizooboats/"
target="_blank"
rel="noreferrer noopener"
...
strokeMiterlimit="10" />
                ...
                <li><a className="flex items-center p-1 border-2 rounded-full border-blue-500"
                       href="https://www.instagram.com/zizoo_boats/"
target="_blank"
rel="noreferrer noopener"
...
strokeMiterlimit="10" />
                ...
                <li><a className="flex items-center p-1 border-2 rounded-full border-blue-500"
                       href="https://www.facebook.com/ZizooBoats"
target="_blank"
rel="noreferrer noopener"
                       aria-label="Facebook">
                  <svg viewBox="0 0 11 23"
fill="none"
xmlns="http://www.w3.org/2000/svg"
className="w-4 h-4">
...
clipRule="evenodd"
                ...
                <li><a className="flex items-center p-1 border-2 rounded-full border-blue-500"
                       href="https://www.youtube.com/zizooboats"
target="_blank"
rel="noreferrer noopener"
                       aria-label="YouTube">
                  <svg fill="currentColor"
...
strokeMiterlimit="10" />
                ...
                <li><a className="flex items-center p-1 border-2 rounded-full border-blue-500"
                       href="https://twitter.com/ZizooBoats"
target="_blank"
rel="noreferrer noopener"
                       aria-label="Twitter">
                  <svg fill="currentColor"
...
clipRule="evenodd">
                    <path fill="#ff5f00"
d="M20.308 22.201h10.18V5.081h-10.18z" />
                    <path fill="#eb001b"
                          d="M21.358 13.64c0-3.473 1.58-6.566 4.04-8.56a10.338 10.338 0 00-6.536-2.328c-5.84 0-10.574 4.875-10.574 10.889 0 6.013 4.734 10.888 10.574 10.888 2.467 0 4.736-.87 6.535-2.328-2.46-1.994-4.039-5.087-4.039-8.56z" />
                    <path fill="#f79e1b"
                          d="M42.172 20.495v-.53h-.108l-.123.365-.123-.365h-.107v.53h.075v-.4l.116.345h.078l.116-.345v.4zm-.68 0v-.44h.138v-.09h-.35v.09h.138v.44zm1.013-6.855c0 6.014-4.734 10.89-10.573 10.89-2.467 0-4.737-.87-6.535-2.329 2.46-1.994 4.039-5.087 4.039-8.56s-1.58-6.567-4.04-8.56a10.338 10.338 0 016.536-2.329c5.84 0 10.573 4.875 10.573 10.889z" />
                  </g>
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg"
fill="none"
...
clipRule="evenodd">
                    ...
                    <path
                      d="M10.42 10.098H5.184l-.04.248c4.07.991 6.766 3.389 7.882 6.267l-1.137-5.505c-.197-.759-.765-.983-1.47-1.01zm8.845 11.974l2.028-11.976h3.246l-2.032 11.976z" />
                  </g>
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg"
fill="none"
...
clipRule="evenodd">
              ...
              <div data-min-width="1025"
data-locale="en-GB"
data-template-id="53aa8807dec7e10d38f59f32"
                   data-businessunit-id="53a837e0000064000578f8ba"
