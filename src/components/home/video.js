export default function Video() {
  return (
    <div className="py-10 bg-gray-100 md:py-16">
      ...
      >
        <a
          href="https://www.youtube.com/watch?v=zIV8y6SAbq0"
          target="_blank"
        ...
        >
          <h1 className="text-3xl font-semibold capitalize">The Zizoo experience</h1>
          <p className="md:text-xl">
            Sit back
            and
            relax while we take care of building your dream experience at sea.
          </p>
          <a
            href="https://www.zizoo.com/en/zizoo-yacht-charter-services"
            className="block py-3 text-lg font-semibold bg-white border-2 border-solid rounded text-zz-blue-500 border-zz-blue-500 px-14"
          >
            Explore
            more
          </a>
