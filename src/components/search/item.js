      ...
      <div><a
        ...
        <article className="self-center w-full overflow-hidden bg-white rounded-lg shadow group">
          <div
            ...
            <header className="pt-3.5 px-3.5 sm:px-0 row-start-1 col-start-2 col-end-4 space-y-1.5"><h2
              className="text-base font-semibold leading-6 text-zz-blue-500 line-clamp-2 sm:text-lg">{item.boat.title}</h2>
            ...
            <div id="specs"
              ...
              <ul className="inline list-none md:block">
                <li className="inline before:content-['·'] before:mx-1 first-of-type:before:hidden">7 max.
                  guests
                </li>
                <li className="inline before:content-['·'] before:mx-1 first-of-type:before:hidden">5.99 m
                  long
                </li>
              </ul>
              <ul className="inline list-none md:block">
                <li className="inline before:content-['·'] before:mx-1 md:first-of-type:before:hidden">Captain
                  optional
                </li>
                <li className="inline before:content-['·'] before:mx-1 first-of-type:before:hidden">35 kt max
                  speed
                </li>
                <li className="inline before:content-['·'] before:mx-1 first-of-type:before:hidden">115 hp
                  engine
                </li>
              </ul>
            </div>
            <div id="badges"
              ...
              <div className="flex flex-wrap gap-1">
                <div
                  className="inline-flex text-xs leading-4 font-medium rounded-xl py-1 px-2.5 bg-green-100 text-green-800 sm:inline-flex">Bimini
                  top
                </div>
              </div>
            </div>
            <div id="rating"
              ...
              <div className="px-2 text-sm font-medium leading-5 rounded-md text-zz-blue-500 bg-gray-50">★ 5.0
              </div>
              <div
                className="pt-1.5 text-zz-blue-400 hidden sm:block text-sm leading-none text-right font-normal">2
                ratings
              </div>
            </div>
            <div id="price"
              ...
              <div className="flex flex-row items-end justify-end space-x-2 sm:flex-col sm:pt-0">
                <div
                  className="text-xs leading-4 font-medium bg-gray-50 rounded-xl text-zz-blue-500 text-center py-1 px-2.5 ml-auto sm:mb-1">price
                  for 3 days
                </div>
                <div className="space-y-1"><span
                  className="text-base font-bold leading-6 text-zz-blue-500 sm:text-lg">£944</span></div>
              </div>
            </div>
          </div>
        </article>
